<x-layouts.app>
    <div class="p-6 flex justify-center">
        <div class="w-full max-w-xl bg-white dark:bg-zinc-800 shadow rounded p-6">
            <h1 class="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Edit Blog Category</h1>
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST">
                ...
                @method('PUT')
                <div class="mb-4">
                    <flux:input name="name" :label="__('Name')" type="text" value="{{ old('name', $category->name) }}" required />

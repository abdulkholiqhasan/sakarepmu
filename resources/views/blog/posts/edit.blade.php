        ...
        <div class="bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-700 px-4 sm:px-6 py-3 sm:py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2 sm:space-x-4">
                    <h1 class="text-xl sm:text-2xl font-normal text-gray-900 dark:text-white">Edit Post</h1>
                </div>
                    ...
                    <div class="p-4">
                        <div class="mb-3">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white">{{ old('status', $post->status ?? 'Draft') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="pt-3 border-t border-gray-200 dark:border-zinc-700">
                            <div class="flex flex-col gap-2">
                                ...
                                <button 
                                    ...
                                    name="action" 
                                    value="revert" 
                                    onclick="return confirm('Are you sure you want to revert this post to draft?')" 
                    ...
                    <div class="p-4">
                        ...
                        <div id="featured-preview">
                            @if(old('featured_image', $post->featured_image))
                                <img src="{{ old('featured_image', $post->featured_image) }}" alt="Featured" class="w-full object-cover rounded border border-gray-300 dark:border-zinc-700" style="max-height: 150px;" />
                            @endif
                        </div>
                    </div>
                </div>
...
<script>
    // Auto-generate slug from title (WordPress style) - For edit page, assume initially edited
    (function(){
        const title = document.querySelector('input[name="title"]');
        const slug = document.querySelector('input[name="slug"]');
        if(!title || !slug) return;
        let manuallyEdited = true; // For edit page, assume initially edited
...
<script>
    // Categories functionality (WordPress style)
    (function(){
...
<script>
    // Tags functionality (WordPress style)
    (function(){

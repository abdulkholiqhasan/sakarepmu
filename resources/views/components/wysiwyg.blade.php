...
<div class="wysiwyg-component">
    ...
    <div id="{{ $name }}-editor" class="min-h-[200px] bg-white dark:bg-zinc-900 rounded border dark:border-zinc-700 p-3">
        {!! $value !!}
    </div>
</div>
...
<script>
    (function(){
        ...
        function initEditorFor(name){
            ...
            let toolbarContainer = editorEl.parentNode.querySelector('.ql-toolbar');
            if(!toolbarContainer){
                toolbarContainer = document.createElement('div');
                toolbarContainer.className = 'ql-toolbar';
                toolbarContainer.innerHTML = '<span class="ql-formats"></span>';
                editorEl.parentNode.insertBefore(toolbarContainer, editorEl);
            }
            ...
            (function(){
                ...
                if(!container.querySelector('.ql-table')){
                    ...
                    btn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><path d="M3 9h18"/><path d="M9 3v18"/></svg>';
                ...
                if(!container.querySelector('.ql-video')){
                    ...
                    vbtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="5" width="20" height="14" rx="2" ry="2"/><path d="M10 9l6 3-6 3z"/></svg>';
                ...
                (function(){
                    const toolbarNode = (quill.getModule && quill.getModule('toolbar') && quill.getModule('toolbar').container) || toolbarContainer;

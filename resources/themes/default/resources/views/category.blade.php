...
@section('title', $category->name . ' - ' . (\App\Models\Setting::where('key', 'site_title')->value('value') ?? config('settings.site_title', 'Blog')))
...
<div class="container mx-auto py-8">
    ...
    @else
        <p>Tidak ada post ditemukan pada kategori ini.</p>
    @endif
</div>
@endsection
